...
def main():
    wavelengths = [400e-9,800e-9] #wavelength of pump and signal pulses in m
    ...
    length = .3 #length of fiber in m

    pressure_range = [0,2] #range of pressures in bar for optimize_pressure to scan over
    radius = 100e-6 #inner radius of fiber in m
    gas = 'He'
    T = 293.15 #temperature of fiber in K

    pulse_duration = 40e-15 #FWHM of intensity of pulses in s
    energy_in = np.array([.5,.5,0])*1e-3 #energy of each pulse in J
    ...
    # frog_anim_p.save(filename="/Users/davidgarcia/Desktop/frog_p.gif", writer="pillow")
    # frog_anim_s.save(filename="/Users/davidgarcia/Desktop/frog_s.gif", writer="pillow")
    # frog_anim_i.save(filename="/Users/davidgarcia/Desktop/frog_i.gif", writer="pillow")
    plt.show()
